...
//	Section attempting to display and hide escape button based on whether its iframed or not.
	...
	var showEscape = (window.self == window.top);
	
	if(showEscape) {
		var escapeLink = document.getElementById("escapeLink");
		var page = window.location.href;
		switch(page) {
			case "https://www.ntattorneys.com/GroupChat/index.php":
			case "http://www.ntattorneys.com/GroupChat/index.php":
			case "https://www.volunteerlogin.org/GroupChat/index.php":
			case "http://www.volunteerlogin.com/GroupChat/index.php":
			case "https://ntattorneys.com/GroupChat/index.php":
			case "http://ntattorneys.com/GroupChat/index.php":
			case "http://23.114.103.43/GroupChat/index.php":
			case "http://volunteerlogin.com/GroupChat/index.php":
				escapeLink.style.display = "block";
				break;
			default:
				escapeLink.style.display = null;
		}
	} else {
		var escapeLink = document.getElementById("escapeLink");
		escapeLink.style.display = "none";
	}
...
function roomOpen() {
	...
	if(loggedOnModerators == 0 && (!groupChatModeratorFlag || groupChatModeratorFlag == 0)) {
